...
<script type="text/javascript">
	$(function() {
		panels = [ {
			...
			height : 255,
			collapsible : true,
			href:'${pageContext.request.contextPath }/portal/gonggao'
		}, {
			id : 'p2',
			title : '信息报备',
			height : 255,
			collapsible : true,
			href:'${pageContext.request.contextPath }/portal/daiban'
		}, {
			id : 'p3',
			title : '提醒预警',
			height : 255,
			collapsible : true,
			href:'${pageContext.request.contextPath }/portal/yujing'
		}, {
			id : 'p4',
			title : '系统BUG反馈',
			height : 255,
			collapsible : true,
			href:'${pageContext.request.contextPath }/portal/bug'
		}];
