...
/**
 *  自定义realm
 *  用户对应的角色信息与权限信息都保存在数据库中，通过SysService和RoleService获取数据
 * @author zhq_zhao
 *
 */
public class CustomRealm extends AuthorizingRealm {
	 ...
	 * 提供用户信息返回权限信息
	 * PrincipalCollection：主要的信息集合
	 * 每个用户所对应的角色信息所对应的权限信息
	 */
	@Override
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		//将上边查询到授权信息填充到simpleAuthorizationInfo对象中， 将权限名称提供给info
		//添加完成之后代表该用户对应的角色具有的权限
